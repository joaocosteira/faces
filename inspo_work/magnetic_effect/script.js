...
class MagneticObject {
    ...
    render(){
        ...
        if(distanceFromMouseToCenter < this.triggerArea){
            ...
            targetHolder.x = (mousePosition.x - (this.boundingClientRect.left + this.boundingClientRect.width / 2))
            targetHolder.y = (mousePosition.y - (this.boundingClientRect.top + this.boundingClientRect.height / 2))
        }else{
